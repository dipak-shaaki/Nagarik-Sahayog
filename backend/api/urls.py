...
urlpatterns = [
    ...
    path('emergency/simulate/<int:pk>/', SimulateMovementView.as_view(), name='simulate_movement'),
    path('emergency/location/update/', UpdateLocationView.as_view(), name='update_location'),
